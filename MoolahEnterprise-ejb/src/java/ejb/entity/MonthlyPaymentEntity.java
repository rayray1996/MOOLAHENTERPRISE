 ...
 */
@Entity
public class MonthlyPaymentEntity implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof MonthlyPaymentEntity)) {
            return false;
        }
        MonthlyPaymentEntity other = (MonthlyPaymentEntity) object;
