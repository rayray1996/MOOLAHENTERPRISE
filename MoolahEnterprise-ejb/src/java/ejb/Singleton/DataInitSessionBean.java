...
public class DataInitSessionBean {
    ...
    public void dataInit() {
        ...
        if (em.find(CompanyEntity.class, 1L) == null) {
            try {
                // Create Company
                CompanyEntity alibabaCompany = new CompanyEntity("Alibaba", "MoolahTesting1233@gmail.com", "BZ8899202", "96968959", "password", BigInteger.valueOf(800L), "aia-group-limited-vector-logo.svg", "https://www.aia.com.sg/en/our-products.html");
