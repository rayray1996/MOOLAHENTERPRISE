...
*/
        if (em.find(CompanyEntity.class, 1L) == null) {
            try {
                // Create Company
                CompanyEntity alibabaCompany = new CompanyEntity("Alibaba", "moolahtesting555@gmail.com", "BZ8899202", "96968959", "password", BigInteger.valueOf(3000L), "Burchett.svg", "https://www.aia.com.sg/en/our-products.html");
                alibabaCompany = companySessionBean.createAccountForCompany(alibabaCompany);
                CompanyEntity tencentCompany = new CompanyEntity("Tencent", "raynnic2020@gmail.com", "BA1828371", "12345678", "password", BigInteger.valueOf(1001L), "Lola and Rose.svg", "https://www.aviva.com.sg/en/contact-us/");
